...
原英文PDF文件：[Drucker Foundation Self-Assessment Tool](/pdf/mission_statement_dev.pdf)

## 1.3 Drucker Foundation Self-Assessment Tool

### 1.3.1 How to Develop a Mission Statement
...
### 1.3.2 Work plan for developing a mission statement
...
9. The meeting concludes with discussion to determine:
   - Whether the group believes it already has developed an effective statement to put forward.
   - Whether the writer should return a single modified draft or two options. o What the writer should most keep in mind when developing the next draft(s). 
   - Who outside the group might be asked for feedback on the emerging statement or next draft(s). 
   - Setting the group's next meeting.
